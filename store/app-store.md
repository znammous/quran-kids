...
- **Description** — رموزُه التعبيريّة من محرفٍ واحد (بلا وصلاتٍ خفيّة)، وهو نفسُه في `store/app-store-description.txt` للنسخ؛ وفي `-b.txt` النسخةُ نفسُها بشرطةٍ بدل النقطة «•»:
