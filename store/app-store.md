...
- **Promotional Text** (١٧٠ حرفاً، يُعدَّل متى شئتَ بلا مراجعة):
  `أصبح حفظُ القرآن رحلةٌ ممتعة: خريطةٌ وقلاع، ومسجدٌ تبنيه بحفظك، وقصصٌ مصوّرة — على وجه المصحف، بلا إعلانات ولا جمع بيانات.`
...
- **Description** — **بلا رموزٍ تعبيريّة: App Store Connect يرفضها في الوصف** (جُرّب 2026-09-24: قُبلت «» و• والتشكيل، ورُفضت الرموز). وهو نفسُه في `store/app-store-description.txt` للنسخ:

```
أصبح حفظُ القرآن في «نور الوحي» رحلةٌ ممتعة: مغامرةٌ تتقدّم فيها وجهاً بعد وجه، وتجمع الجواهر، وتفتح القلاع، وتبني مسجدك آيةً بعد آية. ولا تريد أن تتوقّف.

رحلةٌ مليئة بالمغامرة
